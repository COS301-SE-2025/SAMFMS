"""
Event consumer for GPS service
"""
import aio_pika
import asyncio
import json
...
# Event handlers
async def handle_vehicle_event(event_data: Dict[str, Any], routing_key: str):
    """Handle vehicle-related events"""
    logger.info(f"Handling vehicle event: {routing_key}")
    # Process vehicle events that might affect GPS tracking


async def handle_user_event(event_data: Dict[str, Any], routing_key: str):
    """Handle user-related events"""
    logger.info(f"Handling user event: {routing_key}")
...
async def setup_event_handlers():
    ...
    event_consumer.register_handler("vehicles.*", handle_vehicle_event)
    event_consumer.register_handler("users.*", handle_user_event)
