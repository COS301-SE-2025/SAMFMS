#!/usr/bin/env python3
"""
Startup script for Vehicle Maintenance Service
...
def main():
    ...
    logger.info("Starting Vehicle Maintenance Service...")
    ...
    # Wait for MongoDB
    mongodb_url = os.getenv('MONGODB_URL', 'mongodb://mongodb_vehicle_maintenance:27017')
    ...
    port = os.getenv("VEHICLE_MAINTENANCE_SERVICE_PORT", "8000")
