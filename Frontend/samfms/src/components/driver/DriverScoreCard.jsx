      ...
      <div className="grid grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="bg-background rounded-lg p-2 sm:p-4 border border-border">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            ...
            <span className="text-base sm:text-2xl font-bold text-foreground">
              {driverScore.tripsCompleted}/60
            </span>
          </div>
          <div className="text-xs sm:text-sm font-medium text-foreground">Trips Completed</div>
          <div className="text-2xs sm:text-xs text-muted-foreground">This month</div>
        </div>
        ...
        <div className="bg-background rounded-lg p-2 sm:p-4 border border-border">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            ...
            <span className="text-base sm:text-2xl font-bold text-foreground">
              {driverScore.violations}
            </span>
          </div>
          <div className="text-xs sm:text-sm font-medium text-foreground">Violations</div>
          <div className="text-2xs sm:text-xs text-muted-foreground">This month</div>
        </div>
        ...
        <div className="bg-background rounded-lg p-2 sm:p-4 border border-border">
          ...
          <div className="text-xs sm:text-sm font-medium text-foreground">On-Time Rate</div>
          <div className="text-2xs sm:text-xs text-muted-foreground">This month</div>
        </div>
      </div>
