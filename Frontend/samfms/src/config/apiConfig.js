...
export const API_ENDPOINTS = {
  ...
  GPS: {
    LOCATIONS: {
      ...
      GET: vehicleId => `/gps/locations/${vehicleId}`,
      HISTORY: vehicleId => `/gps/locations/${vehicleId}/history`,
      SEARCH_AREA: '/gps/locations/search/area',
    },
    GEOFENCES: {
      LIST: '/gps/geofences',
      CREATE: '/gps/geofences',
      GET: id => `/gps/geofences/${id}`,
      UPDATE: id => `/gps/geofences/${id}`,
      DELETE: id => `/gps/geofences/${id}`,
    },
    TRACKING: {
      GET: vehicleId => `/gps/tracking/${vehicleId}`,
      START: '/gps/tracking/start',
      STOP: '/gps/tracking/stop',
    },
    PLACES: {
      LIST: '/gps/places',
      CREATE: '/gps/places',
      GET: id => `/gps/places/${id}`,
      UPDATE: id => `/gps/places/${id}`,
      DELETE: id => `/gps/places/${id}`,
    },
  },
  ...
  MAINTENANCE: {
    RECORDS: {
      ...
      SEARCH: '/maintenance/records/search',
    },
    LICENSES: {
      ...
      EXPIRING: '/maintenance/licenses/status/expiring',
      EXPIRED: '/maintenance/licenses/status/expired',
      BY_TYPE: type => `/maintenance/licenses/type/${type}`,
      BY_ENTITY: entityId => `/maintenance/licenses/entity/${entityId}`,
      RENEW: id => `/maintenance/licenses/${id}/renew`,
      DEACTIVATE: id => `/maintenance/licenses/${id}/deactivate`,
      STATISTICS: '/maintenance/licenses/summary/statistics',
    },
    ANALYTICS: {
    ...
    NOTIFICATIONS: {
      ...
      GET: id => `/maintenance/notifications/${id}`,
      UPDATE: id => `/maintenance/notifications/${id}`,
  ...
  ANALYTICS: {
    ...
    CLEAR_CACHE: '/management/analytics/cache',
  },
